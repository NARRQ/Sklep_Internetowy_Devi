...
<div id="menu">
            ...
            <div id="sign" onclick="location.href='article_edit-list.php'">Lista notatek</div>
</div>
    <?php
...
//edycja
    ...
    <div id="login">
        <form name="edit" method="post">
            Tytuł<input type="text" value="<?php echo $row['title']?>" name="title">
            <br><textarea name="article_value" id="article_space" cols="30" rows="10"><?php echo $row['content']?></textarea>
            <br>
