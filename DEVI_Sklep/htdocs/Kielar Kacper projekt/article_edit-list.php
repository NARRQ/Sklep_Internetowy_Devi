<?php
    ...
    {
        header("Location:article_edit-list-admin.php");
        exit();
    }
...
<div id="main-content">
    ...
    <?php
        ...
        $query="select id_art,title,content,authors.Name FROM `articles` inner JOIN authors on authors.Id_author=articles.id_author";
        $result=mysqli_query($connection,$query);
        if($result)
        {
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                <?php
                echo
                "<a href=\"article_edit-list.php?id={$row['id_art']}\">USUŃ</a> 
                <a href=\"article_edit-content.php?id={$row['id_art']}\">EDYTUJ</a> 
                <hr>";
            }
        }
?>
